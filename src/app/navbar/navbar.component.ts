...
export class NavbarComponent {
  constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
    ...
    iconRegistry.addSvgIconLiteral('Angular-up', sanitizer.bypassSecurityTrustHtml(ANG_ICON));
    iconRegistry.addSvgIconLiteral('Git-up', sanitizer.bypassSecurityTrustHtml(Git_Icon));
    iconRegistry.addSvgIconLiteral('Down-up', sanitizer.bypassSecurityTrustHtml(Down_Icon));
    iconRegistry.addSvgIconLiteral('Colour-up', sanitizer.bypassSecurityTrustHtml(Colour_fill));
  }
}
